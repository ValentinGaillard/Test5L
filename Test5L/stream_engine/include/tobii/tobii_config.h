...
@code{.c}
    ...
    tobii_error_t create_device( tobii_api_t* api, tobii_device_t** device, char* url )
    {
        ...
        error = tobii_device_create_ex( api, url, TOBII_FIELD_OF_USE_INTERACTIVE, &license, 1, &license_result, device );
        free( license_key );
        license_key = 0;
...
@code{.c}
    ...
    int main()
    {
        ...
        output_frequency_context_t output_frequency_context;
